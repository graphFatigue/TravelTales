...
namespace TravelTales.API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            {
                this.logger.LogError(ex, "An error occurred while retrieving all categories");
                throw;
            }
        }
        ...
        public async Task<IActionResult> GetAllWithFilter([FromQuery] SieveModel sieveModel, CancellationToken cancellationToken = default)
        {
            ...
            {
                this.logger.LogError(ex, "An error occurred while retrieving filtered categories");
                throw;
            }
        }
        ...
        public async Task<IActionResult> GetById(long id, CancellationToken cancellationToken)
        {
            ...
            {
                this.logger.LogError(ex, "An error occurred while retrieving the category with ID {Id}", id);
                throw;
            }
        }
        ...
        public async Task<IActionResult> Create([FromBody] CreateCategoryDto createCategoryDto, CancellationToken cancellationToken)
        {
            ...
            {
                this.logger.LogError(ex, "An error occurred while creating a new category");
                throw;
            }
        }
        ...
        public async Task<IActionResult> Update(long id, [FromBody] UpdateCategoryDto updateCategoryDto, CancellationToken cancellationToken)
        {
            ...
            {
                this.logger.LogError(ex, "An error occurred while updating the category with ID {Id}", id);
                throw;
            }
        }
        ...
        public async Task<IActionResult> Delete(long id, CancellationToken cancellationToken)
        {
            ...
            {
                this.logger.LogError(ex, "An error occurred while deleting the category with ID {Id}", id);
                throw;
            }
        }
    }
