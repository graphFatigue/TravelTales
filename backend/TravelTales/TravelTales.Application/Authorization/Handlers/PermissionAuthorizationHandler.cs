...
namespace TravelTales.Application.Authorization.Handlers
{
    public class PermissionAuthorizationHandler : AuthorizationHandler<PermissionRequirement>
    {
            ...
            PermissionRequirement requirement)
        {
            ...
            var userIdClaim = userClaims.FirstOrDefault(x => x.Type == System.Security.Claims.ClaimTypes.NameIdentifier);
            ...
            var permissions = userClaims
                .Where(x => x.Type == Constants.TravelTalesConstants.ClaimTypes.Permissions)
                .Select(x => x.Value)
                .ToList();
